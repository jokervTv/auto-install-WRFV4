...
#Start by "wget https://raw.githubusercontent.com/jokervTv/auto-install-WRFV4/master/install_wrf-4_intel.sh && chmod +x install_wrf-4_intel.sh && ./install_wrf-4_intel.sh".
