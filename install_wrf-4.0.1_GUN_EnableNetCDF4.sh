...
#Start by
#wget https://raw.githubusercontent.com/jokervTv/auto-install-WRFV4/master/install_wrf-4.0.1_GUN_EnableNetCDF4.sh && chmod 777 ./install_wrf-4.sh && ./install_wrf-4.sh
